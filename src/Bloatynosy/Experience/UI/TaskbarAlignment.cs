...
namespace Settings.Personalization
{
    ...
    {
        public TaskbarAlignment(Logger logger) : base(logger)
        {
        }
        ...
        {
            return BloatynosyNue.Locales.Strings._uiTaskbarAlignment;
        }

        public override string Info()
        {
            return BloatynosyNue.Locales.Strings._uiTaskbarAlignment_desc;
        }
